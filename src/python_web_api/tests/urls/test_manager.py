...
class TestManager(unittest.TestCase):
    ...
    def test_manager_get(self):
        with requests.get('http://127.0.0.1:15000/manager') as resp:
    ...
    def test_manager_get_with_id(self):
        ...
        with requests.get(f'http://127.0.0.1:15000/manager/{x}') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
    ...
    def test_manager_post(self):
        with requests.post('http://127.0.0.1:15000/manager') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
    ...
    def test_manager_post_with_id(self):
        x = random.randint(1, 10000)
        with requests.post(f'http://127.0.0.1:15000/manager/{x}') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_manager_put(self):
        with requests.put('http://127.0.0.1:15000/manager') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_manager_put_with_id(self):
        x = random.randint(1, 10000)
        with requests.put(f'http://127.0.0.1:15000/manager/{x}') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_manager_delete(self):
        with requests.delete(f'http://127.0.0.1:15000/manager') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_manager_delete_with_id(self):
        x = random.randint(1, 10000)
        with requests.delete(f'http://127.0.0.1:15000/manager/{x}') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
