...
class TestAirplaneToComponent(unittest.TestCase):
    ...
    def test_airplanecomponent_get(self):
        with requests.get('http://127.0.0.1:15000/airplanecomponent') as resp:
        ...
        try:
            ...
            self.fail(msg='Could not parse JSON Data as a AirplaneToComponent')
        ...
        for model in decoded_models:
            self.assertIsInstance(model, models.AirplaneToComponent)
    ...
    def test_airplanecomponent_get_with_id(self):
        ...
        with requests.get(f'http://127.0.0.1:15000/airplanecomponent/{x}') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
    ...
    def test_airplanecomponent_post(self):
        with requests.post('http://127.0.0.1:15000/airplanecomponent') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
    ...
    def test_airplanecomponent_post_with_id(self):
        x = random.randint(1, 10000)
        with requests.post(f'http://127.0.0.1:15000/airplanecomponent/{x}') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_airplanecomponent_put(self):
        with requests.put('http://127.0.0.1:15000/airplanecomponent') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_airplanecomponent_put_with_id(self):
        x = random.randint(1, 10000)
        with requests.put(f'http://127.0.0.1:15000/airplanecomponent/{x}') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_airplanecomponent_delete(self):
        with requests.delete(f'http://127.0.0.1:15000/airplanecomponent') as resp:
            self.assertFalse(resp.ok)
            self.assertEqual(resp.status_code, 405)

    def test_airplanecomponent_delete_with_id(self):
        x = random.randint(1, 10000)
        with requests.delete(f'http://127.0.0.1:15000/airplanecomponent/{x}') as resp:
            self.assertTrue(resp.ok)
            self.assertEqual(resp.status_code, 200)
